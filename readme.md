...
```bash
-v /home/user/.local/share/python_keyring/:/root/.local/share/python_keyring/
```
or if you would like to persist the entire mainnet subdirectory and not touch the key directories at all
```bash
-v /home/user/.chia/mainnet:/root/.chia/mainnet -e keys="persistent"
```
...
```bash
-v /home/user/.chia:/root/.chia \
-v /home/user/.chia_keys:/root/.chia_keys
```
